...
6. A question whose first option is not marked, with a second marked option, or one that takes several answers (`multiSelect`) is never picked. It waits for you, and one yellow entry says so.
