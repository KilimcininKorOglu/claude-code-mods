...
6. Sayımlar ve sabitlenmiş prompt'lar plugin store'da yaşar, proje başına bir deck, o projenin her session'ı tarafından paylaşılır. Proje, session'ın git top level adıdır; yoksa çalışma dizininin adı. Proje başına en fazla 200 prompt tutulur; en az kullanılan ve en eski olan önce gider.
