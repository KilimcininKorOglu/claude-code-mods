...
Bir pencere çalışırken interactive bir session satırı her dakika yeniden çizer; böylece kalan süre ve bir sonraki ping'e kalan süre turn'ler ve ping'ler arasında da geri sayar. Son ping satırda kalır.
...
Reach L2, Claude'u sürer.
    ...
    4. Saklar:   $.store içinde pencere sonunu, ping periyodunu ve son main-loop isteğinin zamanını bu session'ın id'si altında, ve global always switch'ini (sonsuz döngünün yanında pencere key'ine ihtiyacı yoktur); bu session'ın biten penceresi duruşta ve bir sonraki başlangıçta silinir, başka bir session'ın penceresi bittikten bir hafta sonra, başka bir session'ın istek zamanı bir saat eskidiğinde; soğuk write sayacı bellekte yaşar ve session ile biter
