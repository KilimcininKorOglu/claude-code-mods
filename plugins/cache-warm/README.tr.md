...
Bir pencere çalışırken interactive bir session satırı her dakika yeniden çizer; böylece kalan süre ve bir sonraki ping'e kalan süre turn'ler ve ping'ler arasında da geri sayar. `last` kısmı satırda kalır.
