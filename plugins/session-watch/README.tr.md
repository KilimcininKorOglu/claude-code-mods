...
**Sidebar'ın en üstünde bir bölüm** (`order: 5`), Claude Code 2.1.282 üzerinde ölçüldü:
    ...
    ctx 8% · 81k / 1.0M · I 2 · O 8 · TH 5 · CR 74k · CW 7k · CH 91%
...
Reach L2, git, head ve tail çalıştırır.
