...
| [idle-art](plugins/idle-art) | Draws an ASCII animation above the prompt while the model works: matrix rain, fire, a star field, an aquarium or the Game of Life. Display only: nothing reaches the model. | L0 |
